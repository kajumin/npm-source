  ...
  <el-form :rules="rules" :model="rulesForm" status-icon ref="ruleForm">
    <div class="cen">
      <el-form-item class="btn">
        <el-button type="success" @click="onSubmits()" v-if="formMess.Shows"
          >注册并签到</el-button
        >
      </el-form-item>
      <el-form-item class="btn">
...
<script>
// import { get } from '@/api/detection/wx.js'
// import { adduser } from '@/api/detection/wx.js'
export default {
  name: 'from',
  data() {
    return {
  ...
  created() {
    ...
    // const targetPageId = queryString.split('&')[0].split('=')[1]
    // const state = queryString.split('&')[1].split('=')[1]
  ...
  methods: {
    onSubmit() {
      ...
      //     that.formMess.openid = response.constiables.openid
